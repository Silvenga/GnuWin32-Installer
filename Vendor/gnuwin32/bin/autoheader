...
BEGIN
{
  my $datadir = $ENV{'autom4te_perllibdir'} || 'c:/progra~1/autoconf/share/autoconf';
  unshift @INC, "$datadir";
...
# Lib files.
my $autom4te = $ENV{'AUTOM4TE'} || 'c:/progra~1/autoconf/bin/autom4te';
local $config_h;
my $config_h_in;
my @prepend_include;
my @include;
...
# $VERSION
# --------
$version = "autoheader (GNU Autoconf) 2.63
