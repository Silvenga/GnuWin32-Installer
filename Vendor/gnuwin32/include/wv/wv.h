...
# ifdef BUILD_WV_DLL
#  define WV_DLL_IMPEXP     __DLL_EXPORT__
# elif defined(BUILD_WV_STATIC)
#  define WV_DLL_IMPEXP      
# elif defined (USE_WV_DLL)
#  define WV_DLL_IMPEXP     __DLL_IMPORT__
# elif defined (USE_WV_STATIC)
#  define WV_DLL_IMPEXP      
# else /* assume USE_WV_DLL */
#  define WV_DLL_IMPEXP     __DLL_IMPORT__
# endif
#else /* __WIN32__ */
# define WV_DLL_IMPEXP  
